...

...

wL7GM5QjNFog
-----END CERTIFICATE-----
`)
...
func TestEnsureSecLevel2(t *testing.T) {
	sec_level := GetSecurityLevelGlobal()
	if sec_level != 2 {
		t.Fatalf("Expected SECLEVEL 2, got %d", sec_level)
	}
}
